...
let version = "10.8.0-beta.2"
let checksum = "c5eb9627bbf3f66e4a19cd67eeec7cd279ef0ea49a59a9c2ee2305c9523bf9f9"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "23.0.0-beta.1"),
    ],
    targets: [
        .target(
