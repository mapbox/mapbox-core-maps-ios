...
let version = "10.2.0-rc.1"
let checksum = "cb6f210c5e5ee071b33bb7de88af80f92f250d1e72809906e533d715a0994a68"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "21.0.0-rc.2"),
    ],
    targets: [
        .target(
