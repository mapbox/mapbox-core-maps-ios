...
let version = "10.4.0-beta.2"
let checksum = "659ad407695cef205c27997562efee4037c1dabac2a23a6ccc5db81488bbd0bd"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "21.2.0-beta.1"),
    ],
    targets: [
        .target(
