...
let version = "10.0.0-beta.21"
let checksum = "f8bc4a7802e651b9bb0730cea8d6eeeade08bf7717c837ca900bdcb0dbee3ae6"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "11.0.2"),
    ],
    targets: [
        .target(
