...
let checksum = "b59b17a84a00e12c1dc717d09cc9e0721662848a1471422387c4a9d3e7918133"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "10.0.0-beta.7"),
    ],
    targets: [
        .target(
