...
let checksum = "f058da0f9e1299aa8eba6581457a06c4fcdec3ed22de727265276b52bb120675"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "14.0.1"),
    ],
    targets: [
        .target(
