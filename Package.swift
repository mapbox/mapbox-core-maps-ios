...
let version = "10.0.0-rc.5"
let checksum = "4edde4d1cd425c5bf7c1bcec67aa85e060d63e51ffdf32d0097bfdc52dd621e7"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "16.0.0"),
    ],
    targets: [
        .target(
