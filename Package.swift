...
let version = "10.8.0-rc.1"
let checksum = "39548c03de5e57f199601dc0bee418fad3dde38dd91c91b591160d420af280ed"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "23.0.0-rc.2"),
    ],
    targets: [
        .target(
