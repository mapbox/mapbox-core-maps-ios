...
let version = "11.6.0-beta.1"
let checksum = "4760d8101b41f794a6555cf0408e6b2c605586101350222ab94cb9627196eee1"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "24.6.0-beta.1"),
    ],
    targets: [
        .target(
