...
let version = "10.7.0-rc.1"
let checksum = "b091bef46aa98e72b55f644374d038c1f9ee896e554f63bde2267f77ad84711d"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "22.1.0-rc.1"),
    ],
    targets: [
        .target(
