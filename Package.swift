...
let version = "11.5.0-beta.1"
let checksum = "2c8518f90a01f779aa9b4a81004cdb81bed4a9aa5a4fd2e17916117774776081"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "24.5.0-beta.4"),
    ],
    targets: [
        .target(
