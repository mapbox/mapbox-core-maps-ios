...
let version = "10.7.0-beta.1"
let checksum = "01f5447c17baa6a1fa1843727505a12c45e4e4036715dd09f9b8f27acb31f856"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "22.1.0-beta.1"),
    ],
    targets: [
        .target(
