...
let version = "10.0.0-beta.19"
let checksum = "50ff29d456125b09a96ebb62bd2a65483caef7481855d3c42b2be73b214bfb9a"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", .exact("11.0.0")),
    ],
    targets: [
        .target(
