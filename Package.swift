...
let version = "10.2.0-beta.2"
let checksum = "528b92e101fe5409e6fe906092559a8cfed1ea9e247dd018091344bbe47a157c"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "21.0.0-rc.1"),
    ],
    targets: [
        .target(
