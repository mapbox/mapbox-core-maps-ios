...
let version = "10.1.1"
let checksum = "a25bdda6f12fead55a40500dbe5d61a68dde82645c6c19f3207ebf7fe59491af"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "20.1.1"),
    ],
    targets: [
        .target(
