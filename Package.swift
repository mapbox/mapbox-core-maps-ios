...
let version = "10.6.2"
let checksum = "62653545babe566da2b3466154d101009738018df24d1e62521b246a6593d7c8"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "22.0.0"),
    ],
    targets: [
        .target(
