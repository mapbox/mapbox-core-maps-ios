...
let version = "10.0.0-rc.7.1"
let checksum = "fb611d33a15b63ab0378b7a8445e16dd68c3c7a764cb302666a129c31d7a2b9c"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "17.0.0"),
    ],
    targets: [
        .target(
