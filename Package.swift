...
let version = "10.0.0-beta.23"
let checksum = "a9120b7f961a4ee0ca40e3d4d380b0775fcd9149d836a868fe913fbd4b8b37d2"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "13.0.0"),
    ],
    targets: [
        .target(
