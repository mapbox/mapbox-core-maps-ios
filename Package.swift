...
let version = "10.0.0-rc.9.1"
let checksum = "f5d5c60e383667351c7dd787a987f4b3fc23d660c8284816a7a5307e6386e802"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "19.0.0"),
    ],
    targets: [
        .target(
