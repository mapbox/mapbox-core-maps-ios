...
let version = "10.1.0-rc"
let checksum = "30f4ca7d249e973bbe8fda5b165f9cb4101adf1b6b9754cf837f6f071fdd51cf"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "20.1.0-rc.2"),
    ],
    targets: [
        .target(
