...
let version = "10.6.0-rc.1"
let checksum = "d5cd6c19ac2f3a190224e0c3a755343688d8c19b569dc8712b9efc8fd310a10d"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "22.0.0-rc.2"),
    ],
    targets: [
        .target(
