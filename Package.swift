...
let version = "10.0.0-beta.14"
let checksum = "aa5dc8a750eeda854c70fd40d2ef288a33fa7b8710c50e1bc89d71b17f882f77"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "10.0.0-beta.9"),
    ],
    targets: [
        .target(
