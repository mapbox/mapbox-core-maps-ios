...
let version = "10.0.0-beta.22"
let checksum = "3b31d95f3e72e8da54002561c80770b0bcff378c730e6df80f8a9fdcfdc62db7"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "12.0.0"),
    ],
    targets: [
        .target(
