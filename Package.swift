...
let version = "10.1.0"
let checksum = "dbcacabe851edac9ea44888a8675df7e88f4b71a9dc127dd260e4c6440982eff"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "20.1.0"),
    ],
    targets: [
        .target(
