...
let version = "11.3.0-beta.1"
let checksum = "6be437cca4b10f99adcea271ee76d14e914fdfdbe507b3254074d7ed7d15e2ef"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "24.3.0-beta.1"),
    ],
    targets: [
        .target(
