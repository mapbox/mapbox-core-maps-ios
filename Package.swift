...
let version = "10.4.0-rc.1"
let checksum = "49f1c2abc7a3f5486147c3576a12572e96e75b84580f01f3ba667bb1c3f18aba"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "21.2.0-rc.1"),
    ],
    targets: [
        .target(
