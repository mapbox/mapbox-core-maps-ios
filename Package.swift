...
let version = "11.2.3"
let checksum = "132d5752d0dbc788158e47a09a997858985ccfa59b65642694b21ed89c9cb8f0"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "24.2.3"),
    ],
    targets: [
        .target(
