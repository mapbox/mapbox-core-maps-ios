...
let version = "10.1.0-beta"
let checksum = "f84aafd7cd02a49cb3faa6096fa1f22b6d64b558361229ce732798237fa8e295"
...
let package = Package(
    ...
    dependencies: [
        .package(name: "MapboxCommon", url: "https://github.com/mapbox/mapbox-common-ios.git", from: "20.1.0-rc.1"),
    ],
    targets: [
        .target(
